...
func TestConvM(t *testing.T) {
	...
	tests := []test{
		{10, "mm", []float64{10, 1, 0.1, 0.01, 0.001, 0.0001, 0.00001}},
		{10, "cm", []float64{100, 10, 1, 0.1, 0.01, 0.001, 0.0001}},
		{10, "dm", []float64{1000, 100, 10, 1, 0.1, 0.01, 0.001}},
		{10, "m", []float64{10000, 1000, 100, 10, 1, 0.1, 0.01}},
		{10, "dam", []float64{100000, 10000, 1000, 100, 10, 1, 0.1}},
		{10, "hm", []float64{1000000, 100000, 10000, 1000, 100, 10, 1}},
		{10, "km", []float64{10000000, 1000000, 100000, 10000, 1000, 100, 10}},
		{10, "youremad", []float64{}},
	}
...
func TestConvMArea(t *testing.T) {
	...
	tests := []test{
		{10, "mm2", []float64{10, 0.1, 0.001, 0.00001, 0.0000001, 0.000000001, 0.00000000001}},
		{10, "cm2", []float64{1000, 10, 0.1, 0.001, 0.00001, 0.0000001, 0.000000001}},
		{10, "dm2", []float64{100000, 1000, 10, 0.1, 0.001, 0.00001, 0.0000001}},
		{10, "m2", []float64{10000000, 100000, 1000, 10, 0.1, 0.001, 0.00001}},
		{10, "dam2", []float64{1000000000, 10000000, 100000, 1000, 10, 0.1, 0.001}},
		{10, "hm2", []float64{100000000000, 1000000000, 10000000, 100000, 1000, 10, 0.1}},
		{10, "km2", []float64{10000000000000, 100000000000, 1000000000, 10000000, 100000, 1000, 10}},
		{10, "youremad", []float64{}},
	}
...
func TestConvMCubic(t *testing.T) {
	...
	tests := []test{
		{10, "mm3", []float64{10, 0.01, 0.00001, 0.00000001, 0.00000000001, 0.00000000000001, 0.00000000000000001}},
		{10, "cm3", []float64{10000, 10, 0.01, 0.00001, 0.00000001, 0.00000000001, 0.00000000000001}},
		{10, "dm3", []float64{10000000, 10000, 10, 0.01, 0.00001, 0.00000001, 0.00000000001}},
		{10, "m3", []float64{10000000000, 10000000, 10000, 10, 0.01, 0.00001, 0.00000001}},
		{10, "dam3", []float64{10000000000000, 10000000000, 10000000, 10000, 10, 0.01, 0.00001}},
		{10, "hm3", []float64{10000000000000000, 10000000000000, 10000000000, 10000000, 10000, 10, 0.01}},
		{10, "km3", []float64{10000000000000000000, 10000000000000000, 10000000000000, 10000000000, 10000000, 10000, 10}},
		{10, "youremad", []float64{}},
	}
